...
def process():
    ai = NotionAI(TOKEN)
    topic = ai.blog_post(
        "I want you to write out one small but important software development common sense topic in English in the form of an interrogative sentence. I want a different topic than the ones you've answered before. Only write the first line and never add any additional explanation after it. Don't put any symbols in the sentences, just text. Don't put spaces at the beginning and end of the sentences. Do not put a space at the beginning of a sentence.")
    ...
    threading.Timer(120, process).start()
